...
const resources = {
  ko: {
    translation: {
      ...
      about_source_link2: '테레비 아사히 굿모닝 사이트 바로가기 (주말 운세 제공)',
      ...
      about_contact_desc: '질문 및 건의사항은 straycat405@gmail.com으로 보내주세요.',
      // Privacy Page
      ...
      privacy_contact_desc: '개인정보 관련 문의사항이 있으시면 straycat405@gmail.com으로 연락해 주세요.',
      // Terms Page
      terms_title: '이용약관',
  ...
  ja: {
    translation: {
      ...
      about_source_link2: 'テレビ朝日グッド！モーニング 占いページへ（週末占い提供）',
      ...
      about_contact_desc: 'ご質問やご提案は straycat405@gmail.com までお送りください。',
      // Privacy Page
      ...
      privacy_contact_desc: 'プライバシーに関するお問い合わせは、straycat405@gmail.comまでご連絡ください。',
      // Terms Page
      terms_title: '利用規約',
  ...
  en: {
    translation: {
      ...
      about_source_link2: 'Visit TV Asahi Good Morning Site (Weekend Horoscope)',
      ...
      about_contact_desc: 'For questions or suggestions, please email us at straycat405@gmail.com.',
      // Privacy Page
      ...
      privacy_contact_desc: 'For privacy-related inquiries, please contact us at straycat405@gmail.com.',
      // Terms Page
